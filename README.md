...
### Deploy to Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://github.com/Suhail1626/public-forward-bot)
...
### VPS deploying -
``` 
git clone https://github.com/Suhail1626/public-forward-bot && cd public-forward-bot
```
```
